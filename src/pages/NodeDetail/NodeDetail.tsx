...
const chartData = {
  ...
  yearData: [
    ...
    { time: '2021-07-11', value: 1000 },
    { time: '2021-07-18', value: 600 },
    { time: '2021-07-20', value: 600 },
    { time: '2021-07-21', value: 600 },
    { time: '2021-07-22', value: 600 },
    { time: '2021-07-23', value: 600 },

    { time: '2021-07-24', value: 600 },
    { time: '2021-07-27', value: 600 },
  ],
  allData: [],
};
interface TradeType {
  ...
  useEffect(() => {
    ...
    while (i < 14) {
      ...
      const tableItem = {
        ...
        result: '$2,001',
        reqLink:
          'https://api.coincap.io/v2/assets/aelfdata/usdPrice, timestamp',
      };
      ...
      <section className="content">
        ...
        <div className="statistics">
          ...
          <div className="data-item-content">
            ...
            <div>
              <p className="title">{t('oracle node set-up time')}</p>
